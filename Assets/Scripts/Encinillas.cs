...
public class Encinillas : Location {
	public GameObject Gileno;

	// Use this for initialization
	void Start () {
		locationName = "Encinillas";
		...
		int maxCitizen = (int)(Config.ENCINILLAS_MAX_CITIZENS * (1 + Random.Range (-Config.POPULATION_VARIANCE, Config.POPULATION_VARIANCE)));
