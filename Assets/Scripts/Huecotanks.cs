...
public class Huecotanks : Location {
	public GameObject Gileno;
	
	// Use this for initialization
	void Start () {
		locationName = "Hueco tanks";
		...
		int maxCitizen = (int)(Config.HUECOTANKS_MAX_CITIZENS * (1 + Random.Range (-Config.POPULATION_VARIANCE, Config.POPULATION_VARIANCE)));
