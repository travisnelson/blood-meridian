...
public class Gallego : Location {
	public GameObject Mexican;

	// Use this for initialization
	void Start () {
		locationName = "Gallego";
		...
		for (int i=0; i<Config.GALLEGO_MAX_CITIZENS * (1 + Random.Range(-Config.POPULATION_VARIANCE,Config.POPULATION_VARIANCE)); ++i) {
