...
public class Carrizal : Location {
	public GameObject Mexican;

	// Use this for initialization
	void Start () {
		locationName = "Carrizal";
		...
		for (int i=0; i<Config.CARRIZAL_MAX_CITIZENS * (1 + Random.Range(-Config.POPULATION_VARIANCE,Config.POPULATION_VARIANCE)); ++i) {
